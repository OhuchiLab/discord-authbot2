...
| `import_students` | /import_students | 管理者 | CSV から学生情報を一括登録する (確認画面は `import_students_view`) |
...
from .import_students import setup_import_students_command
...
def setup_all_commands(bot: AuthBot) -> None:
    ...
    setup_import_students_command(bot)
